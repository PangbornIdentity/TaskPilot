...
public interface ITagService
{
    ...
    Task<TagResponse?> UpdateTagAsync(Guid id, UpdateTagRequest request, string userId, string modifiedBy, CancellationToken cancellationToken = default);
    Task<bool> DeleteTagAsync(Guid id, string userId, string modifiedBy, CancellationToken cancellationToken = default);
}
